...
a new Server.
    ...
    - Provide the name, location of the runtime root directory (you have to download this), and
      the location of your JDK, then click Finish. This would get you back to the new server setup
      page where you will click on Finish. You probably have to reboot eclipse after this step.
    - You would see the server you just installed in the "Servers". If it is not running, right
...
4. Script - The peopleware.sql file contain the sql statements that could be used to preload data 
            into the database
